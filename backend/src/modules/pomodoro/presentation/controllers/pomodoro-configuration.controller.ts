...
export class PomodoroConfigurationController {
  ...
  @Post()
  @ApiOperation({
    operationId: 'pomodoroCreate',
    summary: 'Create a Pomodoro configuration',
  })
  @ApiSuccessResponse(
  ...
  async create(
    ...
    @Body() body: PomodoroConfigurationRequestDto,
  ) {
    return PomodoroConfigurationResponseDto.fromDomain(
  ...
  @Get(':id')
  @ApiOperation({
    operationId: 'pomodoroGet',
    summary: 'Get one Pomodoro configuration',
  })
  @ApiSuccessResponse(
    PomodoroConfigurationResponseDto,
  ...
  @Put(':id')
  @ApiOperation({
    operationId: 'pomodoroUpdate',
    summary: 'Update a Pomodoro configuration',
  })
  @ApiSuccessResponse(
    PomodoroConfigurationResponseDto,
  ...
  @Delete(':id')
  @ApiOperation({
    operationId: 'pomodoroDelete',
    summary: 'Delete configuration without deleting history',
  })
  @ApiSuccessResponse(
    DeletePomodoroResponseDto,
