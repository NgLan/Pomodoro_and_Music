...
export function NowPlaying() {
  ...
  return (
    <div className="border-border bg-surface flex items-center gap-2.5 rounded-xl border-2 p-2 sm:p-2.5">
      <PlaylistThumbnail
        src={current?.thumbnailUrl ?? null}
        alt=""
        className="aspect-square size-13 sm:size-15 shrink-0 rounded-lg"
      />
