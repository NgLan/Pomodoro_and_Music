...
function ActiveTimer(props: TimerCardProps & { configuration: PomodoroConfigurationResponseDto }) {
  ...
  return (
    <Card className="bg-surface relative min-h-0 sm:min-h-[23rem] overflow-hidden p-2 sm:p-3">
      <span className="bg-accent-yellow border-border absolute -top-7 -right-8 size-24 rotate-12 rounded-3xl border-3" />
      <TimerContent
        timer={timer}
